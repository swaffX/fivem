...
Citizen.CreateThread(function()
    ...
    print("^2[RENTCAR DEBUG]^7 Ped model yüklendi: " .. Config.pedModel)
    ...
    for i, target in pairs(Config.pzones) do
        ...
        print("^2[RENTCAR DEBUG]^7 Ped oluşturuldu - Zone " .. i .. " - Entity: " .. tostring(ped))
        
        -- PED PERSISTENCE - Asla kaybolmasın!
        ...
        TaskStartScenarioInPlace(ped, "WORLD_HUMAN_CLIPBOARD_FACILITY", -1, false)
        ...
        print("^2[RENTCAR DEBUG]^7 Blip oluşturuldu - Zone " .. i)
        ...
        print("^2[RENTCAR DEBUG]^7 Target zone eklendi - Zone " .. i)
    end
    
    print("^2[RENTCAR DEBUG]^7 Tüm ped'ler ve target zone'lar oluşturuldu")
