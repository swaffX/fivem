...
Config.Motels = {
    ...
    ["motel"] = {
        label = "Motel",
        coords = vector3(1142.17, 2663.82, 38.16),
        pedModel = "a_m_y_stwhi_01",
        rentPrice = 150,
        rentFee = 15,
        rooms = {
            [1] = {door = vector3(1141.0, 2664.0, 38.16), h = 0.0, doortext = vector3(1141.0, 2664.0, 38.16), stash = vector3(1143.0, 2664.0, 38.16), obj = nil, clothe = vector3(1145.0, 2664.0, 38.16), locked = true},
            [2] = {door = vector3(1141.0, 2668.0, 38.16), h = 0.0, doortext = vector3(1141.0, 2668.0, 38.16), stash = vector3(1143.0, 2668.0, 38.16), obj = nil, clothe = vector3(1145.0, 2668.0, 38.16), locked = true},
            [3] = {door = vector3(1141.0, 2672.0, 38.16), h = 0.0, doortext = vector3(1141.0, 2672.0, 38.16), stash = vector3(1143.0, 2672.0, 38.16), obj = nil, clothe = vector3(1145.0, 2672.0, 38.16), locked = true},
            [4] = {door = vector3(1141.0, 2676.0, 38.16), h = 0.0, doortext = vector3(1141.0, 2676.0, 38.16), stash = vector3(1143.0, 2676.0, 38.16), obj = nil, clothe = vector3(1145.0, 2676.0, 38.16), locked = true},
            [5] = {door = vector3(1141.0, 2680.0, 38.16), h = 0.0, doortext = vector3(1141.0, 2680.0, 38.16), stash = vector3(1143.0, 2680.0, 38.16), obj = nil, clothe = vector3(1145.0, 2680.0, 38.16), locked = true},
        }
    },
}