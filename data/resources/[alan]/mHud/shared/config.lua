...
Config.WaterMarkInformations = { -- informations displayed in the upper right watermark
    ...
    servername = "Nexora Roleplay",
    discordlink = "discord.gg/Q6vcRA2VY9"
}
...
Config.MoneyHud = {
    ...
    vip_money = {
        show = false,  -- VIP coin göstergesini gizle
        getMoney = function(this)
...
Config.EnableVehicleModes = false  -- Araç modu ayarlarını kapat
Config.VehicleModes = {
    ["sport"] = { 
...
-- BENDEN ANI OLARAK KALSIN MA1KHOV