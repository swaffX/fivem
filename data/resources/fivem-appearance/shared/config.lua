...
Config.Stores = {
    ...
    {shopType = "clothing", coords = vector4(463.51, -998.92, 30.69, 92.81), width = 2, length = 2, showBlip = false}, --POLİS GİYİM
    ...
    {shopType = "surgeon", coords = vector4(316.36, -589.63, 43.29, 181.83), width = 2, length = 2, showBlip = false},
}

Config.ClothingRooms = {
    {requiredJob = "police", isGang = false, coords = vector4(1003.07, -3353.84, -4.5, 87.72), width = 3, length = 3},
    {requiredJob = "police", isGang = false, coords = vector4(1305.92, -3151.34, -11.41, 357.93), width = 3, length = 3}, -- Right double door in Hospital Map that is on QBCore GitHub
}
