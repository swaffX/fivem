...
RegisterNetEvent('qb-simpefarming:sellItems', function()
    ...
    if Player.PlayerData.items ~= nil and next(Player.PlayerData.items) ~= nil then
        ...
        TriggerClientEvent('QBCore:Notify', src, "Eşyalarını başarıyla sattın!")
    else 
		TriggerClientEvent('QBCore:Notify', src, "Satacak herhangi bir eşyan yok!")
	end
end)
------------------------------- Apple Stuff ----------------------------
...
RegisterServerEvent('qb-simplefarming:cowmilking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..cow_milkbucket.. " kova süt sağdın")
end)
...
RegisterServerEvent('qb-simplefarming:cowkilling', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "İneği kestin  " ..cowraw_meat1.. " adet çiğ inek eti ve 1 adet inek derisi elde ettin ")
end)
...
RegisterServerEvent('qb-simplefarming:getcowbucket', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "Boş kovayı aldın")
end)
...
RegisterServerEvent('qb-simplefarming:pumpkinpicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "" ..pumpkinfarming.. " Adet Balkabağı topladın")
end)
...
RegisterServerEvent('qb-simplefarming:cornpicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..cornfarming.. " Adet mısır topladın")
end)
...
RegisterServerEvent('qb-simplefarming:grapepicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..grapepicking.. " Adet üzüm topladın") 
end)
...
RegisterServerEvent('qb-simplefarming:gpepperpicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..gpepperpicking.. " Adet yeşil biber topladın")
end)
...
RegisterServerEvent('qb-simplefarming:chypepperpicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..chypepperpicking.. " Adet acı biber topladın")
end)
...
RegisterServerEvent('qb-simplefarming:tomatoespicking', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, " " ..tompicking.. " Adet domates topladın")
end)
...
RegisterServerEvent('qb-simplefarming:pigfood', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "Domuz için yem aldın  $" ..price.. " kesildi")
    ...
    TriggerClientEvent('QBCore:Notify', source, "Çiftçiden " ..pigfoodamount.. " adet soya fasülyesi aldın", "success")
end)
...
RegisterNetEvent('qb-simplefarming:feedingpiglit', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "Domuzu besledin " ..feedpigamount.. " adet soya fasülyeni yedi", "success")
end)
...
RegisterNetEvent('qb-simplefarming:slayreward', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "Domuzu kestin " ..rawbacon.. " Çiğ domuz pastırması " ..rawham.. " Çiğ jambon " ..rawpork.. " Domuz eti " ..rawsausage.. " biraz deri ile çiğ sosis")
end)
