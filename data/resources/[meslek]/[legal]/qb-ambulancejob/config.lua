Config = {}
Config.UseTarget = GetConvar('UseTarget', 'true') == 'false' -- Use qb-target interactions (don't change this, go to your server.cfg and add setr UseTarget true)
...
Config.BillCost = 10 -- Price that players are charged for using the hospital check-in system
...
Config.BleedTickRate = 80000000 -- How much time, in seconds, between bleed ticks
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(354.22, -1409.28, 32.43),
	    [2] = vector3(349.98, -1411.14, 32.43),		-- paleto
        [3] = vector3(347.57, -1413.98, 32.43),
	    [4] = vector3(345.46, -1416.63, 32.43),
	},
    ["duty"] = {
        [1] = vector3(345.77, -1421.82, 32.43),
        [2] = vector3(347.72, -1416.99, 32.43),
    },
    ["vehicle"] = {
        [1] = vector4(295.05, -607.21, 43.01, 70.51),
        [2] = vector4(-264.78, 6340.72, 32.43, 269.7),
    },
    ["helicopter"] = {
        [1] = vector4(299.08, -1453.77, 46.5, 121.27),
        [2] = vector4(312.96, -1464.84, 46.51, 238.35),
    },
    ["armory"] = {
        [1] = vector3(347.35, -1436.0, 32.94),
        [2] = vector3(-252.09, 6313.34, 32.43),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(-827.25, -1237.82, 7.34),
    },
    ["stash"] = {
        [1] = vector3(-821.79, -1240.03, 7.34),
        [2] = vector3(-247.15, 6314.51, 32.43),
    },
    ["beds"] = {
        [1] = {coords = vector4(352.83, -1438.7, 30.2, 128.17), taken = false, model = 1631638868},
        [2] = {coords = vector4(361.34, -1438.78, 30.2, 325.39), taken = false, model = 1631638868},
        [3] = {coords = vector4(360.5, -1435.15, 30.2, 157.82), taken = false, model = 1631638868},
        [4] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
        [5] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
        [6] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
        [7] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
        [8] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
        [9] = {coords = vector4(358.5, -1433.06, 30.2, 145.65), taken = false, model = 1631638868},
	--- paleto
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(356.65, -1408.2, 32.43, 242.65)},
    },
}
