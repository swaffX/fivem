local Translations = {
    ...
    mail = {
        ...
        message = 'Hallo %{gender} %{lastname}, <br /><br />Hiermit erhalten Sie eine Email über die Kosten ihres letzten Krankenhaus besuchs.<br />Die gesammt Kosten betragen: <strong>$%{costs}</strong><br /><br />Wir wüns eine schnelle Genesung!'
    },
    states = {
        irritated = 'irritiert',
