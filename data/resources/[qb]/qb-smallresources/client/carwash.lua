            ...
            for k in pairs(Config.CarWash) do
                ...
                if dist <= 7.5 and Driver == PlayerPed then
                    ...
                    if not washingVehicle then
                        DrawText3Ds(Config.CarWash[k]["coords"]["x"], Config.CarWash[k]["coords"]["y"], Config.CarWash[k]["coords"]["z"], '~g~E~w~ - Aracı Yıka ($'..Config.DefaultPrice..')')
                        ...
                        DrawText3Ds(Config.CarWash[k]["coords"]["x"], Config.CarWash[k]["coords"]["y"], Config.CarWash[k]["coords"]["z"], 'Oto yıkama mevcut değil..')
                    end
                end
            end
        end
