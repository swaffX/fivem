...
Shared.CastTimeMin = 0 -- Minimum Time in seconds between fishing and minigame
Shared.CastTimeMax = 0 -- Maximum Time in seconds between fishing and minigame
...
Shared.MinigameTime = 10 -- Minigame: Amount of time in seconds

Shared.SellLocation = vector4(-1824.36, -1267.09, 7.62, 54.83)

Shared.FishingZones = {
    [1] = { -- Example of a BoxZone (box = true)
    coords = vector3(-1850.53, -1250.21, 8.62),
        heading = 179,
        length = 44.4,
        width = 5.0,
        minZ = 7.62,
