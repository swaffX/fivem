...
RegisterNetEvent('qb-fishing:client:FishingRod', function()
    ...
    if not canFish then
        QBCore.Functions.Notify('Burada balık tutamazsınız..', 'error', 2500)
        return
    end
    ...
    if hasItem then
        ...
        QBCore.Functions.Notify('Balık tutmaya başlamak için hem oltaya hem de yem ihtiyacınız var..', 'error', 2500)
    end
end)
