local Translations = {
    error = {
        ...
        not_in_veh = 'Bir araçta değilsiniz!',
        not_for_sale = 'Bu araç satılık DEĞİLDİR!',
    },
    menu = {
        ...
        sell_back_help = 'İndirimli bir fiyata arabanızı hemen geri satın!',
        interaction = '[E] Arabanı Sat',
    },
    success = {
