    ...
    if cards and cards[1] then
        ...
        for _, v in pairs(Config.ATMModels) do
            ...
            if atm then
                ...
                QBCore.Functions.Progressbar("accessing_atm", "Kartı takıyorsun...", 1500, false, true, {
        ...
        QBCore.Functions.Notify("Bir kart sipariş etmek için lütfen bir şubeyi ziyaret edin", "error")
    end
end)
