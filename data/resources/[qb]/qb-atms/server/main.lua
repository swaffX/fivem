...
CreateThread(function()
    while true do
        Wait(3600000)
        dailyWithdraws = {}
        TriggerClientEvent('QBCore:Notify', -1, "Günlük ATM limiti sıfırlandı!", "success")
    end
end)
        ...
        if dailyWith < Config.DailyLimit then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Şu anda kartınızdan $" .. data.amount .. ' çektiniz. Günlük çekimler: ' .. dailyWithdraws[cardHolder], "success")
                else
            ...
            TriggerClientEvent('QBCore:Notify', src, "Günlük para çekim limitinize ulaştınız!", "error")
        end
    end
end)
