...
Config.General = {
    ...
    TrashBinModels = {
        -1096777189, 666561306, 1437508529, -1426008804, -228596739, 161465839, 600967813, -468629664, 682791951, 1511880420, 218085040,
    ...
    SearchCooldown = 30000, -- In miliseconds
...
Config.Reward = {
    ...
    -- Items you can get
    ItemList = {
        "water_bottle", "plastic", "lockpick","rolex","lighter","empty_weed_bag"
    }
}
