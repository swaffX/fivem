...
RegisterNetEvent('qb-cityhall:server:requestId', function(item, hall)
    ...
    if not Player.Functions.RemoveMoney("cash", itemInfo.cost) then return TriggerClientEvent('QBCore:Notify', src, ('Üstünde yeterince para yok gerekli olan nakit para %s '):format(itemInfo.cost), 'error') end
    local info = {}
